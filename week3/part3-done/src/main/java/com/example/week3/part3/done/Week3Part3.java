...
public class Week3Part3 {
	private static final Logger log = Logger.getLogger(Week3Part3.class.getName());
	...
	public static void main(String[] args) {
		...
		new Week3Part3().calculateDiscount(person);
		System.exit(0);
	}
	...
	private List<DiscountApplier> getAppliers() {
		return Arrays.asList(new OccupationDiscountApplier(new DatabaseRateRepository()), new NoOfBoughtGoodsDiscountApplier(), new NameDiscountApplier());
	}
}
