package com.example.week2.part5.done.assertion;

import com.example.week2.part5.done.Discount;
import com.example.week2.part5.done.Occupation;
...
class DiscountAssertTests {
	...
	void should_not_throw_exception_when_no_discount() {
		DiscountAssert discountAssert = new DiscountAssert(new Discount("foo", Occupation.UNEMPLOYED, 0D));
	...
	void should_throw_exception_when_discount_present() {
		DiscountAssert discountAssert = new DiscountAssert(new Discount("foo", Occupation.UNEMPLOYED, 5D));
	...
	void should_throw_exception_when_discount_rate_not_equal() {
		DiscountAssert discountAssert = new DiscountAssert(new Discount("foo", Occupation.UNEMPLOYED, 2D));
